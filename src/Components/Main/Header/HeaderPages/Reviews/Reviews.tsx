        ...
        <div id="Reviews">
            ...
            <div className="container">
                <div className="Reviews-top-reviews" style={{marginTop: "15%"}}>
                    ...
                    <div className={'Reviews-top-reviews__blockSecond'}>
                        <h1 className="Reviews-top-reviews-right--h1 pb-5">Latest reviews</h1>
                        <div className="Reviews-top-reviews-right">
                            <div className="Reviews-top-reviews-right-one">
                                ...
                                <p className="Reviews-top-reviews-right-one-p">It’s an awesome home with a great
                                    view to
                                    a <br/>
